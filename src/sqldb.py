...
class HallucinationDb():
    ...
    TERM_QUESTIONS_TABLE = "term_questions"
    TERMS_QUESTIONS_TABLE = "terms_questions"
    COMBINED_TERM_QUESTIONS = "combined_term_questions"
    COMBINED_TERMS_QUESTIONS = "combined_terms_questions"
    COMBINED_TERM_QUESTIONS_SAMPLES = "combined_term_questions_samples"
    COMBINED_TERMS_QUESTIONS_SAMPLES = "combined_terms_questions_samples"
    TERM_ANSWERS_TABLE = "term_answers"
